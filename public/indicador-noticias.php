...
<body>
  <div class="page text-center">
                ...
                <ul class="menu2">
                  ...
                  <li class="activado sitio"><a href="">Indicadores <div style="float: right; margin-left: 50px;"><i class=" fa fa-chevron-down"></i></div></a>
                    <ul>
                      ...
                      <li><a class="sitio" href="indicador-noticias.php">Indicador Noticias</a></li>
                    </ul>
                  </li>
                  ...
                  <li> <div id="facebook"> <a href="https://www.facebook.com/Forex-para-todos-300736087161283/" target="_blank"> <img src="../public/images/facebook2.png"  style="width: 30px; height: 30px;"></a></div></li>
                  <!-- <li> <div id="correo"> <a href=""> <img src="../../public/images/correo2.png" width="20" height="20"></a></div></li>-->
                  <li><div id="youtube"> <a href="https://www.youtube.com/channel/UCahmlQy72dwCb7wZcAyoqhQ" target="_blank"> <img src="../public/images/youtube2.png" style="width: 30px; height: 30px;"></a></div></li>
                  <li><div><a href="https://t.me/coberturasEa" target="_blank"><img class="img-footer" src="../public/images/telegram-respo.png" style="width: 30px; height: 30px;"></a></div></li>
                </ul>
                </ul>
              </div>
    ...
    <main class="contenedor">
      <section>
        <div  style="background-image: url(../public/images/img21.jpg); width: 100%; height: 300px; margin-top:-260px;">
          <div class="centrado" style="color: #fff"> <h2 style="font-size: 75px;"> Indicador Noticias </h2> 
   ...
   <section id="ancla1" class="ancla1">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="thumbnail" style=" border:0px; margin: 5%; text-align: justify;">
          <div>
            <img src="../public/images/Indicador.png" width="500" height="500" hspace="5" vspace="5" style="float: right;">
            Hoy en día, las noticias económicas influyen enormemente en el mercado de divisas (forex). Por esta razón, cada comerciante profesional debe tener en cuenta lo que se esperará cuando se negocie antes de las noticias. Aquellos que se negocian manualmente por ellos, NewsInfo puede ser importante para poder prepararse para una noticia o un evento. Aquellos que utilizan Expert Advisors (EA) para ellos, NewsInfo puede ser importante para detener a los robots antes que las noticias porque durante el evento (s) los movimientos de precios podrían estallar y estos movimientos grandes a menudo dan datos falsos a cualquier indicador y / o indicaciones falsas a cualquier indicador. EA. Además de eso, durante el período de noticias, un rápido aumento en la propagación y el deslizamiento puede causar grandes pérdidas y ser capaz de arruinar una excelente estrategia comercial.<br>
            <br>

            En Darkmoon FX, creemos que esta es una herramienta muy efectiva para todos los operadores de forex profesionales en la plataforma MetaTrader 4. No hay necesidad de una aplicación o sitio web donde pueda ver los eventos, "todo en uno" NewsInfo le permite ver inmediatamente todas las noticias / eventos directamente en su gráfico. La interfaz representa toda la información de noticias de una manera moderna y elegante, desarrollada en su totalidad en el entorno MetaTrader 4 (versión 600 y superior).<br>

            El programa puede detener a los Asesores Expertos (EA) y volverlos a activar después de un tiempo predefinido después de las noticias. NewsInfo proporciona diferentes tipos de interfaz dedicados a los desarrolladores que pueden consultar el indicador de última y las siguientes indicaciones de noticias. El programa comprende casi todos los proveedores de noticias de forex populares para que pueda elegir fácilmente su fuente de noticias preferida. En algunos casos, las noticias / eventos históricos también están disponibles en algunos proveedores de noticias, por lo que el indicador NewsInfo podría usarse de manera eficiente durante las pruebas retrospectivas.<br>
  ...
  <section  class="preguntas" style="background-image:  url(../public/images/imagen1.jpeg); width: 100%; background-repeat: no-repeat;background-size: cover; background-attachment: fixed; background-position: center; position: relative;">
