  ...
  <div class="page text-center">
            ...
            <div id="sidebar" class="sidebar" style="list-style: none !important;">
              <div class="contenedor-menu" >
                <ul class="menu2">
                  ...
                  <li class="activado sitio"><a href="">Robot<div class="i-flecha"><i class=" fa fa-chevron-down"></i></div></a>
                    <ul>
                      <li><a class="sitio" href="ccscalpingc.php">CCscalpingc</a></li>
                    </ul>
                  </li>
              ...
              <div id="fdw"  >
                ...
                <nav>
                  ...
                  <ul style="display: table-cell; position: relative;">
                    ...
                    <li class="current"><a href="#">Robot<span class="arrow"></span></a>
                      <ul  style="display: none;" class="sub_menu">
                        <li class="arrow_top"></li>
                        <li class="current"><a href="ccscalpingc.php">CCscalpingc</a></li>
                      </ul>
                    </li>
    ...
    <main class="contenedor">
      <section>
        <div  style="background-image: url(../public/images/img21.jpg); width: 100%; height: 300px; margin-top:-260px;">
          <div class="centrado" style="color: #fff"> <h2 style="font-size: 75px;"> Robot </h2> 
   ...
   <section id="ancla1" class="ancla1">
    ...
    <div class="row" style="margin: 10% auto">
      <div class="col-md-6">
        <div class="thumbnail" style=" border:0px;text-align:center;">
          <div>
            <p>
      ...
      <div class="thumbnail" style="border:0px;">
       <div id="contenedor-slider" class="contenedor-slider">
         <div id="slider" class="slider">
          <section class="slider__section"><img src="../public/images/robot1.png" style="height: 400px;"  class="slider__img"></section>
          <section class="slider__section"><img src="../public/images/robot3.jpeg"   style="height: 400px; " class="slider__img"></section>
            <section class="slider__section"><img src="../public/images/robot2.jpeg"   style="height: 400px; " class="slider__img"></section>
