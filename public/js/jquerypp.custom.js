(function () {
  ...
  var findHelper = function (events, types, callback, selector) {
  ...
  event.findBySelector = function (el, types) {
    ...
    var add = function (selector, event, handler) {
      var select = selectors[selector] || (selectors[selector] = {})

      var events = select[event] || (select[event] = [])
      events.push(handler)
    }
  ...
  event.setupHelper = function (types, startingEvent, onFirst) {
    ...
    var add = function (handleObj) {
      var bySelector; var selector = handleObj.selector || ''
      if (selector) {
    ...
    $(document.documentElement).bind(touchMoveEvent, moveHandler)
      .one(touchStopEvent, function (event) {
        ...
        if (start && stop) {
          ...
          var deltaY = Math.abs(start.coords[1] - stop.coords[1])
