...
function eq(index) {
  ...
  var transitionStart = function (runCallbacks, direction) {
    ...
    var nextSlide = $(swiper.slides[activeIndex])
    var nxt = nextSlide[0].childNodes[1].childNodes[1].childNodes[1].childNodes[1].childNodes[1]
    var nxt2 = nextSlide[0].childNodes[1].childNodes[1].childNodes[1].childNodes[1].childNodes[3]
    var nxtshell = nextSlide[0].childNodes[1].childNodes[1]
    nxt.classList.remove('not-animated')
    nxt.classList.add('animated')
    nxt2.classList.remove('not-animated')
    nxt2.classList.add('animated')

    if (previousIndex > 0) {
      var prevSlide = $(swiper.slides[previousIndex])
      var antshell = prevSlide[0].childNodes[1].childNodes[1]
      var ant = prevSlide[0].childNodes[1].childNodes[1].childNodes[1].childNodes[1].childNodes[1]
      var ant2 = prevSlide[0].childNodes[1].childNodes[1].childNodes[1].childNodes[1].childNodes[3]
      ant.classList.remove('animated')
      ant.classList.add('not-animated')
      ant2.classList.remove('animated')
      ant2.classList.add('not-animated')
    }
