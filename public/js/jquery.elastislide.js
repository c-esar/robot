...
;(function ($, window, undefined) {
  ...
  $.Elastislide.prototype = {
    ...
    _slide: function (dir, tvalue) {
      ...
      var translation = this.translation || 0
      ...
      if (this.support) {
        ...
        this.$el.stop().applyStyle(styleCSS, $.extend(true, [], { duration: this.options.speed,
          complete: function () {
            self._onEndTransition()
          } }))
      }
    ...
    _slideTo: function (pos) {
      ...
      var translation = Math.abs(this.translation) || 0

      var itemSpace = this.options.orientation === 'horizontal' ? this.$items.outerWidth(true) : this.$items.outerHeight(true)

      var posR = translation + this.$carousel.width()

      var ftv = Math.abs(pos * itemSpace)
